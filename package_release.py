...
index.update(versionId=version, name=f"Neon Ward v{version}",
             summary="NeonWard client pack: connected city approach to the Sakura gate and Japanese perimeter walls around the Edo/shrine district. Includes all previous features; no world/player data.")
