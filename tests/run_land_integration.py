...
subprocess.run([str(jdk/'javac.exe'),'-proc:none','-encoding','UTF-8','-cp',compile_cp,'-d',str(qa),str(root/'tests/WestLandIntegration.java'),str(root/'tests/PairedHandsIntegration.java'),str(root/'tests/PairedEffectsIntegration.java'),str(root/'tests/ChainPullIntegration.java'),str(root/'tests/LandTestAddon.java')],check=True)
