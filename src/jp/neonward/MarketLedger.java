...
public final class MarketLedger {
 ...
 public void validate(){
  ...
  for(Account a:accounts.values())if(a.petOwned!=null)for(Integer kind:a.petOwned)if(kind==null||kind<0||kind>=5)throw new IllegalStateException("Invalid pet ownership");
