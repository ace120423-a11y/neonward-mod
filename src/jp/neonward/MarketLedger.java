...
public final class MarketLedger {
 ...
 public static class Account {public boolean tutorialDone;public StreetProgress street=new StreetProgress();public int cityFloor;public int phoneTitle;public List<String> phoneReceipts=new ArrayList<>();public String profileName="PLAYER",profileStatus="街で暮らす冒険者";public Set<String> friends=new LinkedHashSet<>(),friendRequests=new LinkedHashSet<>();public Set<String> casinoVehicles=new HashSet<>();public CasinoGames.Hand blackjack;public int farmSlot;public boolean farmReady;public int homeSlot;public boolean homeReady;public int guildRank,guildRankReports,guildExamField,guildExamTower,guildExamBoss;public boolean guildExamActive;public long guildMealDay=-1;public Map<Integer,Integer> guildQuestRanks=new HashMap<>();public Map<Integer,Integer> guildQuests=new HashMap<>();public long cash=10000;public int[] shares=new int[6];public long[] cost=new long[6];public long realized;public Map<Integer,Integer> cyberRolls=new HashMap<>();public int cyberVersion;public List<Integer> cyberPending=new ArrayList<>();public Set<Integer> cyberOwned=new HashSet<>();public Map<Integer,Integer> cyberSlots=new HashMap<>();}
 public int nextFarmSlot=1;public int nextHomeSlot=1;public long step=0;public int[] prices={120,85,65,100,150,50};
