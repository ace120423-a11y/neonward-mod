...
public class TelevisionScreen extends Screen {
 ...
 @Override public void extractRenderState(GuiGraphicsExtractor g,int mx,int my,float delta){g.fill(x-3,y-3,x+w+3,y+244,0xff08131f);g.outline(x-3,y-3,w+6,247,0xff61efe0);g.text(font,"PULSE TV / YouTube",x+12,y+12,0xff82fff0);g.text(font,"YouTubeの「共有」→「コピー」で動画のURLを取得",x+12,y+29,0xffb9d4de);g.text(font,url.getValue().length()+" / "+TelevisionUrl.MAX_LENGTH+"文字",x+151,y+79,0xffb9d4de);g.text(font,message,x+12,y+102,0xffffc777);super.extractRenderState(g,mx,my,delta);}
}
