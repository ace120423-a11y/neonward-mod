...
public final class TelevisionRoomPolicy {
 /** Radius around the placed TV block's centre, including vertical separation. */
 public static boolean portableRange(double tx,double ty,double tz,double x,double y,double z){double dx=x-(tx+.5),dy=y-(ty+.5),dz=z-(tz+.5);return dx*dx+dy*dy+dz*dz<=100;}
