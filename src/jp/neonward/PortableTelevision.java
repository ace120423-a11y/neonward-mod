...
public final class PortableTelevision {
 ...
 if(l.isEmptyBlock(at)){l.setBlock(at,BlockRegistry.SCREEN.defaultBlockState().setValue(ScreenBlock.HAS_TE,true),3);if(l.getBlockEntity(at) instanceof ScreenBlockEntity be){be.addScreen(side,new Vector2i(1,1),url,new Vector2i(854,480),p,true);be.setChanged();return 1;}}
