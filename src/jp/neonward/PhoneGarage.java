...
public final class PhoneGarage {
 ...
 public static void init(){
  CommandRegistrationCallback.EVENT.register((d,c,e)->{
   ...
   root.then(Commands.literal("view").executes(ctx->{var p=ctx.getSource().getPlayerOrException();var a=StockMarket.ledger==null?null:StockMarket.ledger.account(p.getStringUUID());var o=new com.google.gson.JsonObject();o.addProperty("garage",true);o.addProperty("shop",sales(p));o.addProperty("cash",a==null?0:a.cash);o.add("casinoVehicles",StockMarket.JSON.toJsonTree(a==null?java.util.Set.of():a.casinoVehicles));net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.send(p,new StockMarket.Snapshot(o.toString()));return 1;}));
